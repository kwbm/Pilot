...
void Pilot::PVulkanContext::createFramebufferImageAndView()
{
    ...
    if (_msaa_sample_count != VK_SAMPLE_COUNT_1_BIT)
    {
        _enable_msaa = true;
    }
    else
    ...
    PVulkanUtil::createImage(_physical_device,
                             ...
                             VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT,
                             _msaa_depth_image,
                             _msaa_depth_image_memory,
                             0,
                             1,
                             1,
                             _msaa_sample_count);

    _msaa_depth_image_view = PVulkanUtil::createImageView(
        _device, _msaa_depth_image, _depth_image_format, VK_IMAGE_ASPECT_DEPTH_BIT, VK_IMAGE_VIEW_TYPE_2D, 1, 1);
}
...
VkSampleCountFlagBits Pilot::PVulkanContext::getMaxUsableSampleCount()
{
