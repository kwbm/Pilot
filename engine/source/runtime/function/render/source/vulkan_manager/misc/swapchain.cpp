...
void Pilot::PVulkanManager::clearSwapChain()
{
    ...
    vkDestroyImageView(m_vulkan_context._device, m_vulkan_context._msaa_depth_image_view, NULL);
    vkDestroyImage(m_vulkan_context._device, m_vulkan_context._msaa_depth_image, NULL);
    vkFreeMemory(m_vulkan_context._device, m_vulkan_context._msaa_depth_image_memory, NULL);
